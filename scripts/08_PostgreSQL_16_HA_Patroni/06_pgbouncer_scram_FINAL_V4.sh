...
EOF
    ...
    # CORRECTION V4: Permissions plus permissives pour le conteneur
...
EOF
    ...
    # Lancer le conteneur avec user root pour éviter les problèmes de permissions
...
echo ""
echo "═══════════════════════════════════════════════════════════════════"
echo -e "$OK Installation PgBouncer terminée (V4 - Finale)"
echo "═══════════════════════════════════════════════════════════════════"
echo ""
...
echo "   • Permissions corrigées (644 au lieu de 600)"
