...
# Configuration UFW
ufw allow from 10.0.0.0/16 to any port 6443 proto tcp comment 'K3s API' || true
ufw allow from 10.0.0.0/16 to any port 10250 proto tcp comment 'K3s kubelet' || true
ufw allow from 10.0.0.0/16 to any port 8472 proto udp comment 'K3s VXLAN' || true
ufw allow from 10.0.0.0/16 to any port 51820 proto udp comment 'K3s Flannel WireGuard' || true
ufw allow from 10.0.0.0/16 to any port 2379:2380 proto tcp comment 'K3s etcd' || true
